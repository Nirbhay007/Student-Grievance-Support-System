...
$ret=mysqli_query($con,"SELECT * FROM users WHERE reg_no='$reg' AND userEmail='$email' AND password='$pass'");
...
if(!$mail->Send()) {
  var_dump($mail);
  echo "<div class='alert alert-danger'>Error while sending OTP.</di>";
} else {
  echo "<div class='alert alert-success'> OTP sent successfully.check your Email inbox</div>";
}
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username" placeholder="Email adrress"  required autofocus>
		            <br>
		            <input type="text" class="form-control" name="reg_no" placeholder="reg. no"  required autofocus>
		            <br>
