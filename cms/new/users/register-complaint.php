...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Complaint</option>
                  ...
                  <option value="Branch Query">Branch Query</option>
                   <option value="Marks Query">Marks Query</option>
                   <option value="Management Query">Management Query</option>
...
<?php $sql=mysqli_query($con,"select branchname from branch ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
...
<div class="col-sm-4">
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Choose Semester</option>
                  <option value="General Query">First</option>
                  <option value="General Query">Second</option>
                   <option value="General Query">Third</option>
                   <option value="General Query">Fourth</option>
                   <option value="General Query">Fifth</option>
                   <option value="General Query">Sixth</option>
                   <option value="General Query">Seventh</option>
                   <option value="General Query">Eighth</option>
                </select> 
</div>
...
<script>
    function pageRedirect() {
      window.location.href = "/complaint manahgement new/cms/new/users/time_table.php";
    }      
</script> 
</head>
<body>
    <button type="button" style="color: rgba(52,45,100);" class="box" onclick="pageRedirect()">Time Table Query</button>
    <p><strong>Note:</strong>Time Table problems</p>
</body>
</html>
